...
<html>
	...
	<form method="post" action="edititeration_check.php">
		<body>
			<div class="title">
...
<div class="newproject"> 
					...
					<table border="0" cellspacing="6" cellpadding="6" align="center" >
							<div class="title1">
				<font color="#080404" size="3px"> <b> Edit Iteration </b> </font>
						...
						<tr>
							...
							<td>
								...
								<?php
									...
									$query="select name from project where user_id=$uid;";
									$result=mysql_query($query);
									while($count=mysql_fetch_row($result))
									{
										$project_name=$count[0];
									?>
										<option value="project" selected="selected"><?php echo $project_name; ?></option>
								<?php
									}
